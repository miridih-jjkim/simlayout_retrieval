...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_wo_GraphicGroup_32k_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_wo_GraphicGroup_32k_val.json',
        data_prefix=dict(img='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decorate_detection/Raw/originSize_png/')))

test_dataloader = val_dataloader
val_evaluator = dict(ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_wo_GraphicGroup_32k_val.json')
    ...
    hooks=[
        ...
        dict(type='MMDetWandbHook',
             init_kwargs=dict(
                 ...
                 name='three_groups_wo_GraphicGroup_swin_l_b4_16e'),
            interval=1,
            log_checkpoint=True,
...
work_dir = '/data/checkpoints/jjy/three_groups_wo_GraphicGroup_swin_l_b4_16e'
