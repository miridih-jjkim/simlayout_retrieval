...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_32k_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_32k_val.json',
        data_prefix=dict(img='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decorate_detection/Raw/originSize_png/')))

test_dataloader = val_dataloader
val_evaluator = dict(ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/three_groups_32k_val.json')
...
work_dir = '/data/checkpoints/jjy/three_groups_swin_l_b4_16e_32k'
