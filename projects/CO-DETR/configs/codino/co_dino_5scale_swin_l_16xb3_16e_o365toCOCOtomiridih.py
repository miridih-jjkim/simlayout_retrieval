...
num_classes = 4
batch_size = 2
dataset_type = 'DecorateDetectionDataset'
# model settings
model = dict(
    backbone=dict(
        _delete_=True,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decoration_det_16k_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decorate_det_test_17k.json',
        data_prefix=dict(img='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decorate_detection/Raw/originSize_png/')))

test_dataloader = val_dataloader
val_evaluator = dict(ann_file='/data/miricanvas-ai-labs-official/02.Dataset/01.Find-meaning-groups/01.miricanvas/PPT-template_ko/decorate_det_test_17k.json')
...
work_dir = '/data/checkpoints/jjy/decoration_det_16k_b3_16e'
